...
from lib.networks import HiPar
import time
...
if __name__ == "__main__":
    ...
    args.exp = 'HIPAR' + dataset_name + str(args.img_size)
    snapshot_path = "model_pth/{}/{}".format(args.exp, 'HIPAR')
    ...
    snapshot_path = snapshot_path +'_run173428' # replace 'current_time' with the 'current_time' in your trained folder from 'model_pth' directory

    net = HiPar(n_class=args.num_classes, img_size_s1=(args.img_size,args.img_size), img_size_s2=(224,224), model_scale='small', decoder_aggregation='additive', interpolation='bilinear').cuda()
